...
const floodAnimationStyles = `
  ...
  /* ============================================================
     NEW ANIMATION A: DROPLET SPLASH ON CARD HOVER
     ============================================================ */
  ...
  .droplet-splash {
    position: absolute;
    top: 50%;
    left: 1.25rem; /* aligned with the glowing dot */
    width: 6px;
    height: 6px;
    border-radius: 9999px;
  ...
  /* ============================================================
     NEW ANIMATION B: HORIZONTAL PULSE WAVE (flood surge)
     ============================================================ */
  @keyframes pulseWave {
  ...
  /* ============================================================
     NEW ANIMATION C: RAIN DROP ON GAUGE
     ============================================================ */
  @keyframes dropFall {
...
/* 6 droplet directions (angle, distance) for the splash burst */
...
/* =================================================================
   FEATURE CARD — with droplet splash on hover
   ================================================================= */
const FeatureCard = ({ title, subtitle, children }) => (
  <div className="feature-card relative flex items-start gap-3 bg-white/15 rounded-lg p-3 backdrop-blur-md border border-white/20 shadow-lg shadow-blue-900/20">
    {/* Glowing dot (parent of the splash) */}
...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      >
        {/* ---- NEW: Pulse waves (flood surge travelling across) ---- */}
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          {/* ---- Feature cards with droplet splash on hover ---- */}
          ...
          {/* Live river gauge with droplet rain */}
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-200 text-sm pr-16"
